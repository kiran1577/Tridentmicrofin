  ...
  <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="820" id="AutoNumber1" bgcolor="#FFFFFF" height="613">
    ...
    <tr>
      ...
      <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" id="AutoNumber20">
        <tr>
          <td width="64">&nbsp;</td>
          <td width="756" class="title"><font face="Calibri" style="font-size:9.5pt"Key partners &gt;<span class="titleyell"> 
          Bankers</span></td>
        </tr>
      </table>
      </td>
        ...
        <tr>
          ...
          <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="94%" id="AutoNumber21">
            <tr>
              ...
              <p align="justify" class="body"><font face="Calibri" style="font-size:9.5pt">In addition to the equity capital, Trident has availed debt facilities from Public Sector Banks, Private Banks, Foreign Banks, Financial Institutions and Development Banks..</td>
            </tr>
            <tr>
              <td width="100%" valign="top">
      <img border="0" src="images/spacer-white.gif" width="23" height="21"></td>
            </tr>
            <tr>
              <td width="100%" valign="top">
              <p align="center"><img border="0" src="images/banks.gif"></td>
            </tr>
            <tr>
              <td width="100%" valign="top">
              <img border="0" src="images/spacer-white.gif" width="14" height="13"></td>
            ...
            <tr>
              <td width="100%" valign="top">
              <p align="center"><img border="0" src="images/banks2.gif"></td>
            </tr>
            <tr>
              <td width="100%" valign="top">
              <img border="0" src="images/spacer-white.gif" width="14" height="13"></td>
            ...
            <tr>
              <td width="100%" valign="top">
              <p align="center"><img border="0" src="images/banks3.gif"></td>
            </tr>
            <tr>
              <td width="100%" valign="top">
              <img border="0" src="images/spacer-white.gif" width="14" height="13"></td>
            ...
            <tr>
              <td width="100%" valign="top">
              <p align="center"><img border="0" src="images/banks4.gif"></td>
            </tr>
            <tr>
              <td width="100%" valign="top">
              <img border="0" src="images/spacer-white.gif" width="14" height="13"></td>
            ...
            <tr>
              <td width="100%" valign="top">
              <p align="center"><img border="0" src="images/banks5.gif"></td>
            </tr>
            <tr>
              <td width="100%" valign="top">
              <p align="center"><img border="0" src="images/banks6.gif"> </td>
            </tr>
            <tr>
              <td width="100%" valign="top">
              <img border="0" src="images/spacer-white.gif" width="14" height="13"> </td>
            ...
            <tr>
              <td width="100%" valign="top">
              <p align="center">
              <img border="0" src="images/lakshmivilabank.gif">&nbsp;
              <img border="0" src="images/sbi.gif"></td>
            </tr>
            <tr>
