  ...
  <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="820" id="AutoNumber1" bgcolor="#FFFFFF" height="613">
    ...
    <tr>
      ...
      <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" id="AutoNumber20">
        <tr>
          <td width="64">&nbsp;</td>
          <td width="756" class="title"><font face="Calibri" style="font-size:14pt">Customer Voice</td>
        </tr>
      </table>
      </td>
    </tr>
        ...
        <tr>
          ...
          <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="94%" id="AutoNumber21">
            <tr>
              <td width="100%">
              <p align="justify">
          <span class="body"><font face="Calibri" style="font-size:9.5pt">Trident Microfinance Private Ltd. is a new generation microfinance institution 
          established in 2007 and headquartered at Hyderabad in Andhra Pradesh, 
          India. The Company is promoted by highly qualified microfinance 
          professionals. The overarching goal of the company is to provide 
          comprehensive financial and business solutions to low income 
          individuals and enterprises.</span> </p>
              <p class="body" align="justify"><font face="Calibri" style="font-size:9.5pt">The promoters believe that lower 
          segments of the population provide immense market opportunity for the 
          production and consumption of goods and services, which in turn would 
          boost the economy, once they are equipped with necessary resources.</p>
          <p class="body" align="justify"><font face="Calibri" style="font-size:9.5pt">Financial capital is one such unique and scarce resource that has 
          great potential to catalyze inclusive economic development. Trident 
          aims to make capital available to these communities in most efficient 
          and sustainable manner by sourcing it from commercial and like-minded 
          investors. The Company will strive to generate maximum value to the 
          investor’s capital by adopting cutting-edge technology and innovative 
          business models. A combination of servicing methodologies is being 
          explored with an ultimate objective of <strong><i>‘no bankable poor are left behind’ </i></strong>
          in the areas of operation.</td>
            </tr>
          </table>
          </td>
            ...
            <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="86%" id="AutoNumber18">
			  ...
			  <td width="100%" valign="top">
                <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" id="AutoNumber19">
                  ...
                  <tr>
                    <td width="100%" height="20">
                    <p align="right"><a href="gallery.asp"><font face="Calibri" style="font-size:9.5pt">Gallery</a><img border="0" src="images/bullet-submenu.gif"></td>
                  </tr>
                  <tr>
                    <td width="100%" bgcolor="#CFBD79">
                    <img border="0" src="images/h-line-menu-bg.gif"></td>
