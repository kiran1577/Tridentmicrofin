...
<div align="center">
        ...
        <tr>
          ...
          <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="94%" id="AutoNumber21">
            <tr>
              ...
              <br><font face="Calibri" style="font-size:9.5pt">
              ...
              We have had employees who include from top B- schools, qualified 
  ...
  <td width="100%" bgcolor="#EBFDC1" height="18">
      <font face="Calibri" style="font-size:9.5pt"><b>&nbsp;Fill this form and Submit your 
      Resume...</b></font></td> 
            </tr>-->
            <tr>
              <td valign="top">
...
<td width="100%" valign="top">
                ...
                * </font><font face="Calibri" style="font-size:9.5pt">Fields are mandatory</font></td>
              </tr>-->
              <tr>
                <!--<td width="100%" valign="top">
              <table id="AutoNumber14" style="BORDER-COLLAPSE: collapse" borderColor="#7994B0" cellPadding="4" width="100%" border="1" cellspacing="0">
                <form name="sform"  action="atsendmail.asp" method="post"  enctype="multipart/form-data" onSubmit="return chk_frm()">
                  <tr>
                    ...
                    <font style="FONT-SIZE: 9.5pt" face="Calibri" color="#111111">
                    &nbsp;&nbsp;Name:</font></b></td>
                    <td bgColor="#EFEFEF"><font face="Calibri">
                    <span style="FONT-SIZE: 9.5pt">
                    <input class="input1" size="40" name="Name"> </span></font>
                    <font style="FONT-SIZE: 9.5pt" face="Calibri">&nbsp; </font><b>
                    <font face="Calibri" style="font-size: 9.5pt" color="#ff0000">*</font></b></td>
                  </tr>
                  <tr>
                    <td align="right" bgColor="#FFFFC6"><b>
                    <font style="FONT-SIZE: 9.5pt" face="Calibri" color="#111111">
                    Email:</font></b></td>
                    <td bgColor="#FFFFC6"><font face="Calibri">
                    <span style="FONT-SIZE: 9.5pt"><input size="40" name="Email">
                    </span></font><font style="FONT-SIZE: 9.5pt" face="Calibri">&nbsp;
                    </font><b>
                    <font style="FONT-SIZE: 9.5pt" face="Calibri" color="#ff0000">*</font></b></td>
                  </tr>
                  <tr>
                    <td align="right" bgColor="#EFEFEF"><b>
                    <font style="FONT-SIZE: 9.5pt" face="Calibri" color="#111111">
                  ...
                  <tr>
                    ...
                    <td bgColor="#EFEFEF">
                    <font face="calibri"><span style="FONT-SIZE: 9.5pt">
