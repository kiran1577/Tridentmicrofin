  ...
  <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="820" id="AutoNumber1" bgcolor="#FFFFFF" height="613">
    ...
    <tr>
      ...
      <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" id="AutoNumber20">
        <tr>
          <td width="64">&nbsp;</td>
          <td width="756" class="title"><font face="Calibri" style="font-size:14pt">About us</td>
        </tr>
      </table>
      </td>
    </tr>
        ...
        <tr>
          ...
          <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="94%" id="AutoNumber21">
            <tr>
              <td width="100%">
              <p align="justify">
          <span class="body"><font face="Calibri" style="font-size:9.5pt" >Trident Microfin Private Ltd.is a new generation microfinance 
          ...
          microfinance professionals with the motto <i>'to reach the unreached'</i>. The 
          overarching goal of the company is to provide comprehensive financial 
          and business solutions to low income individuals and enterprises.</span> </p>
          ...
          aims to make capital available to these communities in a most efficient 
          ...
          investors' capital by adopting cutting-edge technology and innovative 
