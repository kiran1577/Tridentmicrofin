  ...
  <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="820" id="AutoNumber1" bgcolor="#FFFFFF" height="613">
    ...
    <tr>
      ...
      <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" id="AutoNumber20">
        <tr>
          <td width="64">&nbsp;</td>
          <td width="756" class="title"><font face="Calibri" style="font-size:14pt">Products and Services</td>
        </tr>
      </table>
      </td>
    </tr>
      ...
      <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" id="AutoNumber5">
        <tr>
          ...
          <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="94%" id="AutoNumber21">
            <tr>
              <td width="100%"><p align="justify" class="body"><font face="Calibri" style="font-size:9.5pt">The Organization is presently
                  offering microcredit and  microinsurance services. The loans
                  are extended to both men and 
              women, in rural as well as urban areas. The key distinction of
                  the  Organization is the continued search for new products
                  and channels 
              through pilot branches/programs. </td>
            </tr>
          </table>
          </td>
              ...
              <tr>
                ...
                <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" id="AutoNumber19">
                  <tr>
                    ...
                    <p align="right"><a href="methodology.asp"><font face="Calibri" style="font-size:9.5pt">Methodology</a><img border="0" src="images/bullet-submenu.gif"></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td width="100%" height="20">
                    <p align="right"><a href="operationalpolicy.asp"><font face="Calibri" style="font-size:9.5pt">Operational 
