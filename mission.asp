  ...
  <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="820" id="AutoNumber1" bgcolor="#FFFFFF" height="613">
    ...
    <tr>
      ...
      <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" id="AutoNumber20">
        <tr>
          <td width="64">&nbsp;</td>
          <td width="756" class="title"><font face="Calibri" style="font-size:14pt">About us &gt;<span class="titleyell"> <font face="Calibri" style="font-size:14pt">Mission</span></td>
        </tr>
      </table>
      </td>
    </tr>
        ...
        <tr>
          ...
          <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="94%" id="AutoNumber21">
            <tr>
              <td width="100%">
              <p align="justify">
			  <span class="body"><font face="Calibri" style="font-size:9.5pt"><strong>Mission</Strong></span><br>
          <span class="body"><font face="Calibri" style="font-size:9.5pt">To reach the unreached low income communities with 
          financial and business solutions in a socially, economically, and 
          environmentally sustainable manner through the efficient use of 
          capital, technology and human resources.<br>
          <br>
          The primary objectives are:</span></p>
              <ul>
                <li><span class="body" align="justify"> <font face="Calibri" style="font-size:9.5pt">To provide comprehensive
                    financial and business solutions to low income individuals
                    particularly women and micro enterprises.</span></li>
                <li><span class="body" align="justify"><font face="Calibri" style="font-size:9.5pt"> To ensure that <strong> No Bankable
                  Poor are Left Behind </Strong > in the area of our operation.</span></li>
              </ul></td>
            </tr>
          </table>
          </td>
              ...
              <tr>
                ...
                <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" id="AutoNumber19">
                  <tr>
                    ...
                    <p align="right"><a href="mission.asp"><font face="Calibri" style="font-size:9.5pt">Mission</a><img border="0" src="images/bullet-submenu.gif"></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td width="100%" height="20">
                    <p align="right"><a href="values.asp"><font face="Calibri" style="font-size:9.5pt">Values and Code of 
                  ...
                  <tr>
                    <td width="100%" height="20">
                    <p align="right"><a href="founders.asp"><font face="Calibri" style="font-size:9.5pt">Founders and 
                  ...
                  <tr>
                    <td width="100%">
                    <p align="right"><a href="seniormanagement.asp"><font face="Calibri" style="font-size:9.5pt">Senior 
